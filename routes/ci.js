        ...
        request(options)
            ...
            .then(function(response) {
                ...
                if (json.data) {
                    ...
                    log.error('Response from backend is invalid.', {
                        response: response
                    });
                }
            })
            .catch(function(err) {
                log.error('Error while processing CI Build Item ID %d', buildItemId, {
            ...
            .catch(function(err) {
                log.error('Error while updating status of failed CI build item ID %d', buildItemId, {
                    errMesage: err.message
                });
            });
    ...
    return request(options)
        ...
        .catch(function(err) {
            if (err.statusCode == 404) {
                ...
                log.error("Can't get .shoov.yml in %s/%s", userName, repositoryName, {
...
var execDocker = function(buildId, buildItemId, accessToken, withSelenium) {
        ...
        return new Promise(function(resolve, reject) {
            ...
            if (withSelenium && seleniumContainerName) {
                containerOptions.HostConfig = {
                    "Binds": [seleniumContainerName + ':selenium']
                };
    ...
    return runSelenium()
        ...
        .catch(function(err) {
            ...
            // And show error.
            log.error('Error while executing docker containers.', {
                errMessage: err.message
            });
        });
